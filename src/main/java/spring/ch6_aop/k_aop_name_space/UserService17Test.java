package spring.ch6_aop.k_aop_name_space;
...
@ContextConfiguration("/UserService17-Test-applicationContext.xml")
public class UserService17Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch6_aop.k_aop_name_space.UserService17Test");
    }
    ...
    static class TestUserService9Impl extends UserService9Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService17Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService17Test.TestUserServiceException e) {
        }

package spring.ch6_aop.m_annotation_transaction;
...
@ContextConfiguration("/UserService19-Test-applicationContext.xml")
public class UserService19Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch6_aop.m_annotation_transaction.UserService19Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService19Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService19Test.TestUserServiceException e) {
        }

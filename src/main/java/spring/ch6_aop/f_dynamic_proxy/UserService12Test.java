package spring.ch6_aop.f_dynamic_proxy;
...
@ContextConfiguration("/UserService12-Test-applicationContext.xml")
public class UserService12Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch6_aop.f_dynamic_proxy.UserService12Test");
    }
    ...
    static class TestUserService9 extends UserService9Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService12Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        UserService9Impl target = new UserService12Test.TestUserService9(users.get(3).getId());
        ...
        } catch (UserService12Test.TestUserServiceException e) {
        }

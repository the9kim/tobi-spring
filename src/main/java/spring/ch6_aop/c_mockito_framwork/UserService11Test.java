package spring.ch6_aop.c_mockito_framwork;
...
public class UserService11Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch6_aop.c_mockito_framwork.UserService11Test");
    }
    ...
    static class TestUserService9 extends UserService9Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService11Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        UserService9Impl testUserService = new UserService11Test.TestUserService9(users.get(3).getId());
        ...
        } catch (UserService11Test.TestUserServiceException e) {
        }

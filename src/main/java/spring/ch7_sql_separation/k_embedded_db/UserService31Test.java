...
@ContextConfiguration("/UserService31-Test-applicationContext.xml")
public class UserService31Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.k_embedded_db.UserService31Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService31Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService31Test.TestUserServiceException e) {
        }

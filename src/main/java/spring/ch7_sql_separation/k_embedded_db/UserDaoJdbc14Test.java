...
@ContextConfiguration(locations = "/UserService31-Test-applicationContext.xml")
public class UserDaoJdbc14Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.k_embedded_db.UserDaoJdbc14Test");
    }

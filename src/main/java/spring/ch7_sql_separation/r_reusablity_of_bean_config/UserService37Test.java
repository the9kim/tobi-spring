...
import spring.ch7_sql_separation.q_property_source.AppContext3;
...
@ContextConfiguration(classes = AppContext4.class)
@ActiveProfiles("test")
public class UserService37Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.r_reusablity_of_bean_config.UserService37Test");
    }

    public static class TestUserService16Impl extends UserService12Impl {
        private String id = "4";

        @Override
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService37Test.TestUserServiceException();
            }
    ...
    @Autowired
    UserService2 testUserService16Impl;
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        try {
            this.testUserService16Impl.upgradeLevels();
            fail("TestUserServiceException expected");
        } catch (UserService37Test.TestUserServiceException e) {
        }

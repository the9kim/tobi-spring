...
@ContextConfiguration(locations = "/UserService23-Test-applicationContext.xml")
public class UserDaoJdbc6Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.c_sql_service.UserDaoJdbc6Test");
    }

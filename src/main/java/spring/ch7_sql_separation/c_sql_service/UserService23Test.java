...
@ContextConfiguration("/UserService23-Test-applicationContext.xml")
public class UserService23Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.c_sql_service.UserService23Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService23Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService23Test.TestUserServiceException e) {
        }

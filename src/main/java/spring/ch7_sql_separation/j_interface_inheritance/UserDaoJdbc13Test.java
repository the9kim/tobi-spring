...
@ContextConfiguration(locations = "/UserService30-Test-applicationContext.xml")
public class UserDaoJdbc13Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.j_interface_inheritance.UserDaoJdbc13Test");
    }

...
@ContextConfiguration("/UserService30-Test-applicationContext.xml")
public class UserService30Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.j_interface_inheritance.UserService30Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService30Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService30Test.TestUserServiceException e) {
        }

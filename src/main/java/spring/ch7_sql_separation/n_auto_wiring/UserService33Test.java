...
import spring.ch7_sql_separation.m_annotation.TestApplicationContext;
...
@ContextConfiguration(classes = TestApplicationContext2.class)
public class UserService33Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.n_auto_wiring.UserService33Test");
    }
    ...
    public static class TestUserService12Impl extends UserService12Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService33Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService33Test.TestUserServiceException e) {
        }

...
@ContextConfiguration("/UserService26-Test-applicationContext.xml")
public class UserService26Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.f_interface_separation.UserService26Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService26Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService26Test.TestUserServiceException e) {
        }

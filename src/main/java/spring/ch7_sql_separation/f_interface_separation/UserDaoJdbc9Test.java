...
@ContextConfiguration(locations = "/UserService26-Test-applicationContext.xml")
public class UserDaoJdbc9Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.f_interface_separation.UserDaoJdbc9Test");
    }

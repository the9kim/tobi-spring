...
@ContextConfiguration("/UserService25-Test-applicationContext.xml")
public class UserService25Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.e_bean_initialization.UserService25Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService25Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService25Test.TestUserServiceException e) {
        }

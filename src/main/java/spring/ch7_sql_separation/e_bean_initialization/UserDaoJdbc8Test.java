...
@ContextConfiguration(locations = "/UserService25-Test-applicationContext.xml")
public class UserDaoJdbc8Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.e_bean_initialization.UserDaoJdbc8Test");
    }

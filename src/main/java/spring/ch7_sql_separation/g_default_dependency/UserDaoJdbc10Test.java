...
@ContextConfiguration(locations = "/UserService27-Test-applicationContext.xml")
public class UserDaoJdbc10Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.g_default_dependency.UserDaoJdbc10Test");
    }

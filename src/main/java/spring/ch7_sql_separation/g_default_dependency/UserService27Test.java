...
@ContextConfiguration("/UserService27-Test-applicationContext.xml")
public class UserService27Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.g_default_dependency.UserService27Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService27Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService27Test.TestUserServiceException e) {
        }

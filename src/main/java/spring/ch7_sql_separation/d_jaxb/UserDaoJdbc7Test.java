...
@ContextConfiguration(locations = "/UserService24-Test-applicationContext.xml")
public class UserDaoJdbc7Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.d_jaxb.UserDaoJdbc7Test");
    }

...
@ContextConfiguration("/UserService29-Test-applicationContext.xml")
public class UserService29Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.i_resource_abstraction.UserService29Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService29Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService29Test.TestUserServiceException e) {
        }

...
@ContextConfiguration(locations = "/UserService29-Test-applicationContext.xml")
public class UserDaoJdbc12Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.i_resource_abstraction.UserDaoJdbc12Test");
    }

...
@ContextConfiguration(locations = "/UserService21-Test-applicationContext.xml")
public class UserDaoJdbc4Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.a_sql_property.UserDaoJdbc4Test");
    }

...
@ContextConfiguration("/UserService22-Test-applicationContext.xml")
public class UserService22Test {

    public static void main(String[] args) {
        JUnitCore.main("spring.ch7_sql_separation.b_sql_property_map.UserService22Test");
    }
    ...
    static class TestUserService11Impl extends UserService11Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService22Test.TestUserServiceException();
            }
    ...
    public void upgradeAllOrNothing() throws SQLException {
        ...
        } catch (UserService22Test.TestUserServiceException e) {
        }

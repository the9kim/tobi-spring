...
import spring.ch7_sql_separation.n_auto_wiring.TestApplicationContext2;
...
public class UserService34Test {
    ...
    public static class TestUserService12Impl extends UserService12Impl {
        ...
        public void upgradeLevel(User3 user) throws SQLException {
            if (user.getId().equals(this.id)) {
                throw new UserService34Test.TestUserServiceException();
            }
